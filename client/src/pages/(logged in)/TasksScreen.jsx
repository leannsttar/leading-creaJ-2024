...
export const TasksScreen = () => {
  return (
    <div className="w-full min-h-full overflow-y-scroll bg-[#f7f7f7] grid grid-cols-1 md:grid-cols-3 font-Poppins">
      <div className="bg-[#FFFFFF] shadow-lg m-8 p-4 max-h-[55vh]">
        <div className="flex justify-between items-center mb-6">
          <p className="text-xl font-bold">Por hacer</p>
        ...
        <div className="mb-4">
          <p className="font-bold text-lg">Improve cards readability</p>
        </div>
        <div className="mb-4 flex justify-center">
          <img
            src="../../../public/test-task.png"
        ...
        <div className="mb-4 flex justify-between">
          <div className="flex items-center">
            ...
            <p className="ml-2">Date 12/12/12</p>
          </div>
          <p className="text-right font-medium">Team C</p>
        </div>
        <div className="flex items-center">
          <img
            src="../../../public/test-boy.png"
